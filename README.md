...
- отчет `Расходы за этот месяц` отправляет PNG с круговой диаграммой расходов по категориям текущего месяца и Telegram-formatted текстовую расшифровку сумм с валютой; категории с долей меньше `5%` объединяются в `Прочие категории`
- отчет `Доходы за этот месяц` отправляет такой же PNG-отчет по категориям доходов текущего месяца с той же агрегацией мелких категорий в `Прочие категории`
